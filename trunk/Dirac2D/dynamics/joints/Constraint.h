...
enum CONSTRAINT_TYPE { ECT_DISTANCE, ECT_HINGE, ECT_WELD, ECT_CATENARY, ECT_CATENARY_FIXED_ROTATION, ECT_LINE, ECT_PRISMATIC, ECT_WHEEL, ECT_MOTOR, ECT_PULLEY, ECT_GEAR, ECT_CUBIC_SPLINE };
